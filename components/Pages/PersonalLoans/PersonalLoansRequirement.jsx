...
function PersonalLoansRequirement() {
  return (
    <div className="pt-24 px-16 pb-16">
      <div className="text-center text-3xl font-bold text-[#27374C] pb-4">
        How it works
      </div>
      {/* <div className="text-2xl font-bold text-[#27374C] py-4">
        <p>Personal Loans Requirement</p>
      </div> */}
...
export default PersonalLoansRequirement;
